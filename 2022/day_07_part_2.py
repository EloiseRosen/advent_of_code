...
space_unused = TOTAL_SPACE - total_size_by_dir['/']
amount_to_del = NEED_UNUSED - space_unused

ans = None
for size in total_size_by_dir.values():
    if size > amount_to_del and (ans is None or size < ans):
        ans = size
print(ans)
