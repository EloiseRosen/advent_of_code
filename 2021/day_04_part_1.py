...
def get_winner(called_nums, boards):
            ...
            for row_idx in range(0, len(board)):
                ...
                if called_num in row:
                    ...
                    if has_won(mark_board):
                        score = calculate_score(last_num_called=called_num, board=board, mark_board=mark_board)
                        return board, score

board, score = get_winner(called_nums, boards)
print(board)
print(score)
